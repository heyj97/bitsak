...
class galleryModel {
  ...
  static async updatePhoto({
    ...
    const updatePhoto =
      "UPDATE gallery SET  description = ?, location = ?, take_date = ?, file_path = ? WHERE gallery_id = ?";
  ...
  static async getGalleryId({ galleryId }) {
    const selectGalleryId =
      "SELECT gallery_id from gallery where gallery_id = ?";
  ...
  static async getLocation({ location }) {
    const selectLocation =
      "SELECT count(*) as count from gallery where location = ?";
